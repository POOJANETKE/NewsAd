...
export class CustomerLogin extends Component {
    ...
    constructor(props) {
     ...
     submitHandler=(e)=>{
      ...
      CustomerService.getCustomer(this.state.emailId,this.state.password).then(res =>{
                            ...
                            <div class="col-lg-6">
                                <form>
                                    <div class="card2 card border-0 px-4 py-5">
                                        <label><h5><i><b> Welcome back customer, Login here!!</b></i> </h5></label>
                                        <div class="row px-3"><label class="mb-1">
                                            <h5 class="mb-0 text-sm"><EmailIcon/> &nbsp;Email Id</h5>
                
                                        </label><input value={this.state.emailId} class="mb-4" type="email" name="emailId" placeholder="Enter a valid email" onChange={this.changeHandler}></input>
                                        </div>
